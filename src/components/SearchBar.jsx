  ...
  return (
    <TextField
      ...
      InputProps={{
        startAdornment: (
          <InputAdornment position="start">
            <SearchIcon
              style={{
                color: theme.palette.mode === "dark" ? "#BFD8B3" : "#FB773C", // Change icon color based on theme
              }}
            />
          </InputAdornment>
        ),
      ...
      sx={{
        ...
        input: {
          padding: "10px 14px",
          color: theme.palette.mode === "dark" ? "#BFD8B3" : "#FB773C", // Change input text color based on theme
        },
        boxShadow: 2,
      }}
    />
